document.documentElement.style.setProperty('--body-font', fontGoogle);(function($) {
						...
						for (var i = 0, feed = entry; i < feed.length; i++) {
							...
							switch (type) {
								...
								case 'videos':
									switch (i) {
										case 0:
											content += '<article class="videos-item item-' + i + '"><div class="videos-inner">' + tag + '<a class="entry-image-link is-video before-mask" href="' + link + '"><span class="entry-thumb" data-image="' + image + '"/></a><div class="entry-header entry-info"><h2 class="entry-title"><a href="' + link + '">' + title + '</a></h2>' + meta[0] + '</div></div></article>';
											break;
										default:
											content += '<article class="videos-item item-' + i + '"><div class="videos-inner"><a class="entry-image-link is-video before-mask" href="' + link + '"><span class="entry-thumb" data-image="' + image + '"/></a><div class="entry-header entry-info"><h2 class="entry-title"><a href="' + link + '">' + title + '</a></h2></div></div></article>';
											break
									}
									break;
								case 'gallery':
...
$(document).ready(function() {
	$('#RicoRights').attr('style', 'margin-left: 3px;display:inline-block !important;visibility: visible!important; opacity: 1!important;z-index: 1!important;').html('<span class="RicoRightsClass"><a href="https://rico-templates.blogspot.com" tooltip="قالب ريكو - متعدد الاستخدامات" target="_blank" style="visibility: visible!important;opacity: 1!important;position: relative!important;z-index: 1!important;width:32px!important;height:32px!important;background: url(https://1.bp.blogspot.com/-NSZOs92_GCE/YTKdhTgN5GI/AAAAAAAAAGY/tCn30-eTlZIzHeLsDFmoO_tnC4AzVnwIgCLcBGAsYHQ/s344/Rico.png) top no-repeat;background-size:contain;-webkit-transition: all 0.15s ease-in-out;-moz-transition: all 0.15s ease-in-out;-ms-transition: all 0.15s ease-in-out;-o-transition: all 0.15s ease-in-out;transition: all 0.15s ease-in-out;display: block!important;vertical-align: top;"></a></span>');
...
"<nav class='table-of-contents' role='navigation'><div><span>محتوى المقال</span><span class='toggled'/></div><ul>";
...
$(document).ready(function() {
	if ($('.post-body h3:visible,.post-body h2:visible').length == 0) {
		$(".ma-pro").css("display", "none");
	}
});
...
function removerscript() {
	var e = document.getElementById("MASLABEL"),
		t = e.parentNode;
	t.removeChild(e)
}
var numfeed = 5,
	startfeed = 0,
	urlblog = window.location.protocol + "//" + window.location.hostname,
	charac = 150,
	urlprevious, urlnext;
onload = function() {
	navigasifeed(0)
